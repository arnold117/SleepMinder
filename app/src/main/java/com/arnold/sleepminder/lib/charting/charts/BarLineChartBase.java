...
import com.arnold.sleepminder.lib.charting.highlight.ChartHighlighter;
...
import com.arnold.sleepminder.lib.charting.interfaces.datasets.IBarLineScatterCandleBubbleDataSet;
import com.arnold.sleepminder.lib.charting.listener.BarLineChartTouchListener;
import com.arnold.sleepminder.lib.charting.listener.OnDrawListener;
import com.arnold.sleepminder.lib.charting.renderer.XAxisRenderer;
import com.arnold.sleepminder.lib.charting.renderer.YAxisRenderer;
...
import com.arnold.sleepminder.lib.charting.jobs.AnimatedMoveViewJob;
import com.arnold.sleepminder.lib.charting.jobs.AnimatedZoomJob;
import com.arnold.sleepminder.lib.charting.jobs.MoveViewJob;
import com.arnold.sleepminder.lib.charting.jobs.ZoomJob;
...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>>
    ...
    protected void calcMinMax() {
        ...
        mAxisLeft.calcMinMax(mData.getYMin(YAxis.AxisDependency.LEFT), mData.getYMax(YAxis.AxisDependency.LEFT));
        mAxisRight.calcMinMax(mData.getYMin(YAxis.AxisDependency.RIGHT), mData.getYMax(YAxis.AxisDependency.RIGHT));
    }
